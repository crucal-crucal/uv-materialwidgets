...
#ifdef CUVSWITCHBTN_LIB
#define CUVSWITCHBTN_EXPORT Q_DECL_EXPORT
#else
#define CUVSWITCHBTN_EXPORT Q_DECL_IMPORT
#endif

class CUVSwitchButtonPrivate;

class CUVSWITCHBTN_EXPORT CUVSwitchButton final : public QWidget {
	Q_OBJECT
