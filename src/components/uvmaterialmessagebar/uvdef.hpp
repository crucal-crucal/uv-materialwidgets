...
#ifdef CUVMATERIALMESSAGEBAR_LIB
#define CUVMATERIALMESSAGEBAR_EXPORT Q_DECL_EXPORT
#else
#define CUVMATERIALMESSAGEBAR_EXPORT Q_DECL_IMPORT
#endif

namespace UVMessageBarType {
Q_NAMESPACE_EXPORT(CUVMATERIALMESSAGEBAR_EXPORT)
...
} // namespace CUVMessageBarType

namespace UVIconType {
Q_NAMESPACE_EXPORT(CUVMATERIALMESSAGEBAR_EXPORT)

/**
 * 使用 Awesome 来绘制图标
 */
enum class CUVIconType : int {
	None                                   = 0x0,
	Broom                                  = 0xe800,
	Number00                               = 0xe801,
	Numbe0                                 = 0xe802,
...
Q_ENUM_NS(CUVIconType)
} // namespace CUVAwesomeType
