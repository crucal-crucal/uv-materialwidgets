...
class CUVMaterialMessageBarPrivate final : public QObject {
	Q_OBJECT
	Q_DISABLE_COPY(CUVMaterialMessageBarPrivate)
	Q_DECLARE_PUBLIC(CUVMaterialMessageBar)

public:
	explicit CUVMaterialMessageBarPrivate(CUVMaterialMessageBar* q, QObject* parent = nullptr);
	~CUVMaterialMessageBarPrivate() override;
...
public:
	CUVMaterialMessageBar* const q_ptr{ nullptr };
	int borderRadius{};
	QString title{};
	QString text{};
