...
CUVMaterialScrollBarStyle::CUVMaterialScrollBarStyle(QStyle* style): QProxyStyle(style) {
}

CUVMaterialScrollBarStyle::~CUVMaterialScrollBarStyle() = default;

void CUVMaterialScrollBarStyle::drawComplexControl(const ComplexControl control, const QStyleOptionComplex* option, QPainter* painter, const QWidget* widget) const {
	switch (control) {
...
int CUVMaterialScrollBarStyle::pixelMetric(const PixelMetric metric, const QStyleOption* option, const QWidget* widget) const {
	switch (metric) {
