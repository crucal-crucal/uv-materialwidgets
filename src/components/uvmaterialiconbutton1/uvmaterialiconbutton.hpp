...
#ifdef CUVMATERIALICONBUTTON1_LIB
#define CUVMATERIALICONBUTTON1_EXPORT Q_DECL_EXPORT
#else
#define CUVMATERIALICONBUTTON1_EXPORT Q_DECL_IMPORT
#endif

class CUVMATERIALICONBUTTON1_EXPORT CUVMaterialIconButton final : public QAbstractButton {
	Q_OBJECT
